...
import com.iqexception.fxhelper.order.stub.MiscServiceStub;
...
public class WxMsgService extends BaseService {
    ...
    public boolean sendReceiptMessage(String shopName,
        ...
        return miscServiceStub.sendMessageQuietly(RECEIPT_MESSAGE_ID, openId, PAGE_CONSUMER_ORDER_LIST, jsonMapper.serialize(message));
