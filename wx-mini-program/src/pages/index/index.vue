...
async function initUserStore() {
  ...
  if (shops && shops.shopInfos) {
    userStore.setShopCount(shops.shopInfos.length);
  }
  if (userOrders && userOrders.orderInfos) {
    userStore.setOrderCount(userOrders.orderInfos.length);
  }
}
